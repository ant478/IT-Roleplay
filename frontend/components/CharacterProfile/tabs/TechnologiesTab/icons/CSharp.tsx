...
export default class CSharp extends SVGIcon {
  public render(): React.ReactNode {
    return (
      ...
      >
        ...
        <g id="Layer_3">
          <path
            style={{ fillRule: 'evenodd', clipRule: 'evenodd', fill: '#37474F' }}
          ...
          />
          <path
            style={{ fillRule: 'evenodd', clipRule: 'evenodd', fill: '#546E7A' }}
          ...
          />
          <path
            style={{ fillRule: 'evenodd', clipRule: 'evenodd', fill: '#455A64' }}

    ...
    return (
      <svg className="svg-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256.4 291.5">
        <g transform="translate(4.988 -113.385)">
          ...
          <path fill="#ebebeb" d="M105.2 338.9c-3.3-1-19.6-5.4-36.2-9.9l-30.1-8.1v-15.1c0-14.8 0-15.1 1.5-14.6.8.3 11.8 3.3 24.4 6.8l22.9 6.3.2-67 .2-67h25v85.2c0 67.7-.2 85.2-.9 85.2-.5-.1-3.7-.9-7-1.8z"/>
          ...
          <path fill="#fff" d="M 203.1 323.4 l 6.9 -83.9 l -51 5.7 v -44.8 l 54.4 -0.2 l 2.2 -30.6 l -82.1 0.4 l 1.1 111.4 l 49.6 -8.5 l -0.7 24.8 l -50 13.3 l 0.5 30.4 l 69.1 -18 z"/>
        </g>
      </svg>
    );
  }

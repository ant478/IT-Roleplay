    ...
    perks: {
      ...
      LiveIssue1: {
        ...
        description: joinWithLineBreaks(
          ...
          '',
          'Когда способность активна время выполнения задачи уменьшается на 30%, качество уменьшается на -30.',
        ),
      },
      LiveIssue2: {
        name: 'Лайв ишью II',
        description: joinWithLineBreaks(
          ...
          '',
          'Когда способность активна время выполнения задачи уменьшается на 40%, качество уменьшается на -25.',
        ),
      },
      LiveIssue3: {
        name: 'Лайв ишью III',
        description: joinWithLineBreaks(
          ...
          '',
          'Когда способность активна время выполнения задачи уменьшается на 50%, качество уменьшается на -20.',
        ),
      },
      Review1: {
        name: 'Ревью I',
        description: joinWithLineBreaks(
          ...
          ' - Ревьюер уровень 1',
          '',
          'Способность может быть применена к уже выполненной задаче. Повышает качество задачи на +10, но не выше обычного уровня качества ревьюера. Нельзя применять к своей задаче.',
        ),
      },
      Review2: {
        name: 'Ревью II',
        description: joinWithLineBreaks(
          ...
          ' - Ревьюер уровень 3',
          '',
          'Способность может быть применена к уже выполненной задаче. Повышает качество задачи на +15, но не выше обычного уровня качества ревьюера и не менее чем на +5. Нельзя применять к своей задаче.',
        ),
      },
      Review3: {
        name: 'Ревью III',
        description: joinWithLineBreaks(
          ...
          ' - Ревьюер уровень 5',
          '',
          'Способность может быть применена к уже выполненной задаче. Повышает качество задачи на +20, но не выше обычного уровня качества ревьюера и не менее чем на +10. Нельзя применять к своей задаче.',
        ),
      },
      Leadership1: {
        name: 'Лидерство I',
        description: joinWithLineBreaks(
          ...
          ' - Тимлид уровень 1',
          '',
          'Все подчиненные тимлида получают следующие бонусы: +10% к скоросты выполнения всех задач.',
        ),
      },
      Leadership2: {
        name: 'Лидерство II',
        description: joinWithLineBreaks(
          ...
          ' - Тимлид уровень 3',
          '',
          'Все подчиненные тимлида получают следующие бонусы: +15% к скоросты выполнения всех задач, +10% к запасу очков выносливости.',
        ),
      },
      Leadership3: {
        name: 'Лидерство III',
        description: joinWithLineBreaks(
          ...
          ' - Тимлид уровень 5',
          '',
          'Все подчиненные тимлида получают следующие бонусы: +20% к скоросты выполнения всех задач, +15% к запасу очков выносливости, +10 к качеству.',
        ),
      },
      Algorithms1: {
        ...
        description: joinWithLineBreaks(
          'Знание алгоритмов I',
          '',
          'Бонус +2 к навыку программирование.',
        ),
      },
      Algorithms2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Уровень 3',
          '',
          'Бонус +4 к навыку программирование.',
        ),
      },
      Algorithms3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Уровень 5',
          '',
          'Бонус +6 к навыку программирование.',
        ),
      },
      Patterns1: {
        ...
        description: joinWithLineBreaks(
          'Знание паттернов I',
          '',
          'Время выполнения всех задач уменьшается на 5%.',
        ),
      },
      Patterns2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Уровень 3',
          '',
          'Время выполнения всех задач уменьшается на 10%.',
        ),
      },
      Patterns3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Уровень 5',
          '',
          'Время выполнения всех задач уменьшается на 15%.',
        ),
      },
      Experience1: {
        name: 'Опыт I',
        description: joinWithLineBreaks(
          ...
          '',
          'К любым проверкам навыков прибавляется модификатор "Мудрости" персонажа.',
        ),
      },
      Experience2: {
        name: 'Опыт II',
        description: joinWithLineBreaks(
          ...
          '',
          'Уменьшает вероятность ошибки при выполнении задачи в 2 раза.',
        ),
      },
      Experience3: {
        name: 'Опыт III',
        description: joinWithLineBreaks(
          ...
          '',
          'Качество выполненной задачи никогда не может быть ниже +10 ("Неплохое").',
        ),
      },
      Boldness1: {
        name: 'Кураж I',
        description: joinWithLineBreaks(
          ...
          ' - Сила 12',
          '',
          'При успешном выполнении задачи с качеством результата не ниже +20 ("Хорошее") время выполнения следующей уменьшается на 5%. Бонус суммируется до 3 раз.',
        ),
      },
      Boldness2: {
        name: 'Кураж II',
        description: joinWithLineBreaks(
          ...
          ' - Сила 15',
          '',
          'При успешном выполнении задачи с качеством результата не ниже +20 ("Хорошее") время выполнения следующей уменьшается на 10%. Бонус суммируется до 3 раз.',
        ),
      },
      Boldness3: {
        name: 'Кураж III',
        description: joinWithLineBreaks(
          ...
          ' - Сила 18',
          '',
          'При успешном выполнении задачи с качеством результата не ниже +20 ("Хорошее") время выполнения следующей уменьшается на 15%. Бонус суммируется до 3 раз.',
        ),
      },
      Concentration1: {
        name: 'Концентрация I',
        description: joinWithLineBreaks(
          ...
          ' - Сила 12',
          '',
          'Время выполнения задачи уменьшается на 10% если одновременно выполняется только одна задача.',
        ),
      },
      Concentration2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Сила 15',
          '',
          'Время выполнения задачи уменьшается на 20% если одновременно выполняется только одна задача.',
        ),
      },
      Concentration3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Сила 18',
          '',
          'Время выполнения задачи уменьшается на 30% если одновременно выполняется только одна задача.',
        ),
      },
      Multitasking1: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Ловкость 12',
          '',
          'Персонаж может работать одновременно над двумя задачами со штрафом -10 к качеству и +20% к времени выполнения для каждой задачи.',
        ),
      },
      Multitasking2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Ловкость 15',
          '',
          'Персонаж может работать одновременно над тремя задачами со штрафом -20 к качеству и +40% к времени выполнения для каждой задачи. Штравы за одновременную работу над двумя задачами те же.',
        ),
      },
      Multitasking3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Ловкость 18',
          '',
          'Персонаж может работать одновременно над двумя или тремя задачами со штрафом +20% и +40% к времени выполнения соответственно без штрафов к качеству.',
        ),
      },
      Experiment1: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Ловкость 12',
          '',
          'Когда способность активна стоимость задачи увеличивается на 50% очков выносливости и качество результата меняется случайным образом на от -20 до +20. Задача приносит на 15% больше опыта.',
        ),
      },
      Experiment2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Ловкость 15',
          '',
          'Когда способность активна стоимость задачи увеличивается на 40% очков выносливости и качество результата меняется случайным образом на от -20 до +20. Задача приносит на 25% больше опыта.',
        ),
      },
      Experiment3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Ловкость 18',
          '',
          'Когда способность активна стоимость задачи увеличивается на 30% очков выносливости и качество результата меняется случайным образом на от -20 до +20. Задача приносит на 35% больше опыта.',
        ),
      },
      Quality1: {
        name: 'Качество I',
        description: joinWithLineBreaks(
          ...
          ' - Выносливость 12',
          '',
          'Когда способность активна стоимость задачи увеличивается на 50% очков выносливости, качество результата повышается на +10, время выполнения увеличивается на 30%.',
        ),
      },
      Quality2: {
        name: 'Качество II',
        description: joinWithLineBreaks(
          ...
          ' - Выносливость 15',
          '',
          'Когда способность активна стоимость задачи увеличивается на 40% очков выносливости, качество результата повышается на +15, время выполнения увеличивается на 30%.',
        ),
      },
      Quality3: {
        name: 'Качество III',
        description: joinWithLineBreaks(
          ...
          ' - Выносливость 18',
          '',
          'Когда способность активна стоимость задачи увеличивается на 30% очков выносливости, качество результата повышается на +20, время выполнения увеличивается на 30%, все проверки навыка "Коммуникация" с персонажами класса "Менеджер" получают штраф -10.',
        ),
      },
      Persistence1: {
        name: 'Стойкость I',
        description: joinWithLineBreaks(
          ...
          ' - Выносливость 12',
          '',
          'Персонаж получает +2 дополнительных очка выносливости за уровень. Бонус применяется как к последующим, так и к уже имеющимся уровням.',
        ),
      },
      Persistence2: {
        name: 'Стойкость II',
        description: joinWithLineBreaks(
          ...
          ' - Выносливость 15',
          '',
          'Любая задача стоит на 5% очков выносливости меньше.',
        ),
      },
      Persistence3: {
        name: 'Стойкость III',
        description: joinWithLineBreaks(
          ...
          ' - Выносливость 18',
          '',
          'Любая задача стоит на 10% очков выносливости меньше.',
        ),
      },
      BasicKnowledge1: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Интеллект 12',
          '',
          'Дополнительные 0.25 очков технологий на уровень начиная со следующего.',
        ),
      },
      BasicKnowledge2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Интеллект 15',
          '',
          'Дополнительные 0.5 очков технологий на уровень начиная со следующего.',
        ),
      },
      BasicKnowledge3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Интеллект 18',
          '',
          'Дополнительно 1 очко технологий на уровень начиная со следующего.',
        ),
      },
      ExactCalculation1: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Интеллект 12',
          '',
          'Когда способность активна стоимость задачи увеличивается на 50% очков выносливости. Для любых проверок аттрибутов вместо стандартного аттрибута для данной проверки используется "Интеллект", если он выше.',
        ),
      },
      ExactCalculation2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Интеллект 15',
          '',
          'Когда способность активна стоимость задачи увеличивается на 40% очков выносливости. Для любых проверок аттрибутов вместо стандартного аттрибута для данной проверки используется "Интеллект", если он выше.',
        ),
      },
      ExactCalculation3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Интеллект 18',
          '',
          'Когда способность активна стоимость задачи увеличивается на 30% очков выносливости. Для любых проверок аттрибутов вместо стандартного аттрибута для данной проверки используется "Интеллект", если он выше.',
        ),
      },
      Rethinking1: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Мудрость 12',
          '',
          'Персонаж получает 15% очков опыта от их обычного числа в случае провала задачи (качество -30 ("Плохое") и ниже).',
        ),
      },
      Rethinking2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Мудрость 15',
          '',
          'Персонаж получает 25% очков опыта от их обычного числа в случае провала задачи (качество -30 ("Плохое") и ниже).',
        ),
      },
      Rethinking3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Мудрость 18',
          '',
          'Персонаж получает 35% очков опыта от их обычного числа в случае провала задачи (качество -30 ("Плохое") и ниже).',
        ),
      },
      Guesswork1: {
        name: 'Метод тыка I',
        description: joinWithLineBreaks(
          ...
          ' - Мудрость 12',
          '',
          'Персонаж может работать над задачами на 1 уровень выше изученных им технологий, при условии что изучен хотя бы первый уровень. При этом он получает штраф -20 к качеству и +40% ко времени выполнения.',
        ),
      },
      Guesswork2: {
        name: 'Метод тыка II',
        description: joinWithLineBreaks(
          ...
          ' - Мудрость 15',
          '',
          'Персонаж может работать над задачами на 1 уровень выше изученных им технологий, при условии что изучен хотя бы первый уровень. При этом он получает штраф -15 к качеству и +30% ко времени выполнения.',
        ),
      },
      Guesswork3: {
        name: 'Метод тыка III',
        description: joinWithLineBreaks(
          ...
          ' - Мудрость 18',
          '',
          'Персонаж может работать над задачами на 1 уровень выше изученных им технологий, при условии что изучен хотя бы первый уровень. При этом он получает штраф -10 к качеству и +20% ко времени выполнения.',
        ),
      },
      ExperienceExchange1: {
        name: 'Обмен опытом I',
        description: joinWithLineBreaks(
          ...
          ' - Харизма 12',
          '',
          'При получении персонажем очков опыта 5% очков от их колличества также получают его товарищи по команде.',
        ),
      },
      ExperienceExchange2: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Харизма 15',
          '',
          'При получении персонажем очков опыта 10% очков от их колличества также получают его товарищи по команде.',
        ),
      },
      ExperienceExchange3: {
        ...
        description: joinWithLineBreaks(
          ...
          ' - Харизма 18',
          '',
          'При получении персонажем очков опыта 15% очков от их колличества также получают его товарищи по команде.',
        ),
      },
      Pride1: {
        name: 'Тщеславие I',
        description: joinWithLineBreaks(
          ...
          ' - Харизма 12',
          '',
          'Если качество выполненной задачи не ниже чем +30 ("Отличное"), 15% потраченных на неё очков выносивости восполняются. Если качество ниже чем 0 ("Обычное") - отнимаются дополнительные 15% очков выносливости.',
        ),
      },
      Pride2: {
        name: 'Тщеславие II',
        description: joinWithLineBreaks(
          ...
          ' - Харизма 15',
          '',
          'Если качество выполненной задачи не ниже чем +30 ("Отличное"), 25% потраченных на неё очков выносивости восполняются. Если качество ниже чем 0 ("Обычное") - отнимаются дополнительные 25% очков выносливости.',
        ),
      },
      Pride3: {
        name: 'Тщеславие III',
        description: joinWithLineBreaks(
          ...
          ' - Харизма 18',
          '',
          'Если качество выполненной задачи не ниже чем +30 ("Отличное"), 35% потраченных на неё очков выносивости восполняются. Если качество ниже чем 0 ("Обычное") - отнимаются дополнительные 35% очков выносливости.',
        ),
      },
    },
    skills: {
